    ...
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input
                                    id="name"
                                    type="text"
                                    class="p-3 bg-gray-200 rounded form-input w-full @error('name') border-red-500 border @enderror"
                                    name="name" 
                                    value="{{ old('name') }}"
                                    autofocus
                                />
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
                <h1 class="text-teal-500 text-3xl text-center">¿Eres reclutador?</h1>
                <p class="text-xl mt-5 leading-7">
                    Crear una cuent totalmente gratis y comienza a publicar hasta 10 vacantes.
                </p>
            </div>
        </div>
    </div>
